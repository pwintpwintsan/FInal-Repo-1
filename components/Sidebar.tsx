...
export const Sidebar: React.FC<SidebarProps> = ({ currentView, onViewChange, activeRole, checkPermission, isOpen, onClose }) => {
  ...
  return (
    <>
      ...
      <div className={`fixed lg:static inset-y-0 left-0 w-64 bg-white text-[#292667] flex flex-col border-r border-slate-100 z-50 transition-transform duration-300 ${isOpen ? 'translate-x-0' : '-translate-x-full lg:translate-x-0'}`}>
              ...
              return (
                <button
                  ...
                  className={`w-full flex items-center gap-3 px-4 py-3 rounded-xl transition-all ${
                    isActive ? 'bg-[#292667] text-white font-bold shadow-lg shadow-[#292667]/20' : 'text-slate-500 hover:bg-slate-50 hover:text-[#292667]'
                  }`}
                >
                  <Icon size={18} strokeWidth={2.5} className={isActive ? 'text-[#fbee21]' : 'text-slate-400'} />
        ...
        <div className="p-4 bg-slate-50 border-t border-slate-100">
           <div className="flex items-center gap-3 px-2 py-1">
              ...
              <div>
                 <p className="text-[10px] font-bold text-[#292667] uppercase leading-none">System Stable</p>
