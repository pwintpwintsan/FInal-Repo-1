    ...
    return (
      <div className="fixed inset-0 z-[150] flex items-center justify-center p-6 bg-[#292667]/80 backdrop-blur-md animate-in fade-in duration-300">
        <div className="bg-white rounded-[3rem] p-12 max-w-md w-full shadow-2xl border-b-[12px] border-[#00a651] text-center animate-in zoom-in-95 duration-300">
          ...
          <button onClick={onClose} className="w-full py-5 px-8 bg-[#292667] text-[#fbee21] rounded-2xl font-black text-lg hover:bg-[#00a651] hover:text-white transition-all uppercase tracking-widest shadow-md border-b-4 border-black/10">
            Great!
          </button>
        </div>
      </div>
  ...
  return (
    <div className="fixed inset-0 z-[100] flex items-center justify-center p-6 bg-[#292667]/60 backdrop-blur-sm animate-in fade-in duration-300">
      <div className="bg-white rounded-[3rem] p-10 max-lg w-full shadow-2xl border-b-[12px] border-[#ec2027] text-center animate-in zoom-in-95 duration-300 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-32 h-32 bg-[#fbee21]/10 rounded-full -mr-16 -mt-16"></div>
        ...
        <div className="bg-slate-50 rounded-[2rem] p-6 mb-8 border-2 border-slate-100 flex items-center justify-between">
           ...
           <div className="p-3 bg-[#fbee21] rounded-xl text-[#292667] font-black shadow-md">
              LVL UP
           </div>
        </div>
        ...
        <div className="space-y-4">
          <button 
            ...
            className="block w-full py-5 px-8 bg-[#292667] text-[#fbee21] rounded-2xl font-black text-lg hover:bg-[#ec2027] hover:text-white transition-all uppercase tracking-tighter shadow-md border-b-6 border-black/20 active:scale-95 disabled:opacity-50"
          >
    ...
    <div className="h-full flex flex-col gap-6 overflow-hidden relative">
      ...
      <div className="w-full bg-[#292667] rounded-[3rem] p-8 text-white shadow-2xl border-b-[12px] border-[#fbee21] flex flex-col md:flex-row items-center justify-between gap-8 flex-shrink-0 relative overflow-hidden">
        ...
        <div className="flex items-center gap-4 md:gap-6 relative z-10">
           ...
           <div className="cursor-pointer group" onClick={() => onViewSyllabus(associatedCourse.id)}>
             <h2 className="text-4xl font-black leading-none tracking-tight uppercase truncate max-w-sm group-hover:text-[#fbee21] transition-colors">{associatedCourse.name}</h2>
             <div className="flex flex-wrap items-center gap-4 mt-3">
                <div className="flex flex-col">
                  <span className="text-[8px] font-black uppercase text-[#fbee21] tracking-[0.2em] leading-none mb-1 opacity-60">HUB COURSE</span>
        ...
        <div className="flex items-center gap-12 px-10 md:border-l-4 border-white/10 relative z-10">
           <div className="text-center group cursor-default">
              <p className="text-5xl font-black text-[#fbee21] leading-none">{cls.students.length} <span className="text-white/20 text-xl font-black uppercase">/ {capacity}</span></p>
           ...
           >
              <TrendingUp size={28} strokeWidth={3} className="group-hover:rotate-12 transition-transform text-[#fbee21]" />
      ...
      <div className="flex-1 bg-white rounded-[3rem] border-2 border-slate-100 shadow-2xl overflow-hidden flex flex-col mb-4">
        ...
        <div className="p-6 bg-slate-50 flex flex-col md:flex-row items-center justify-between border-b-2 border-slate-100 gap-4 shrink-0">
           <div className="w-full md:w-96 flex items-center gap-3 bg-white px-5 py-3 rounded-2xl border-2 border-slate-100 focus-within:border-[#fbee21] transition-all shadow-sm group">
                  ...
                  <div key={student.id} className="p-6 flex items-center justify-between hover:bg-slate-50 transition-all group">
                     <div className="flex items-center gap-6">
                        <div className="relative">
                           ...
                           <div className="absolute -top-2 -right-2 w-7 h-7 bg-[#fbee21] text-[#292667] rounded-lg flex items-center justify-center font-black text-xs shadow-md">
                              {student.attendance}
                           </div>
                        </div>
                        <div>
