    ...
    <div className="fixed inset-0 z-[200] flex items-center justify-center p-4 md:p-6 bg-[#292667]/90 backdrop-blur-md animate-in fade-in duration-300">
      <div className="bg-white rounded-[2rem] w-full max-w-xl max-h-[80vh] shadow-2xl border-t-[6px] border-[#3b82f6] flex flex-col overflow-hidden animate-in zoom-in-95 duration-300">
        ...
        <div className="p-4 border-t border-slate-100 bg-slate-50 shrink-0">
           <button 
             onClick={onClose}
             className="w-full py-3 bg-[#292667] text-[#fbee21] rounded-xl font-black text-[10px] uppercase tracking-widest shadow-lg hover:bg-[#3b82f6] hover:text-white transition-all active:scale-95"
           >
             Close Preview
           </button>
        </div>
  ...
  return (
    <div className="h-full flex flex-col gap-4 overflow-y-auto scrollbar-hide animate-in fade-in duration-500 pb-12">
      ...
      {!isMainAdmin ? (
        ...
        /* COMPACT HEADER FOR MAIN CENTER ADMIN (NO BANNER IMAGE) */
        <div className="w-full bg-white rounded-2xl p-4 shadow-sm border border-slate-100 flex items-center justify-between shrink-0 mb-2">
          ...
          <div className="flex gap-2">
             <button 
                  ...
                  className={`flex items-center gap-2 px-4 py-2 rounded-xl font-black text-[8px] uppercase tracking-widest shadow-lg transition-all border-b-4 border-black/10 active:scale-95 ${isEditing ? 'bg-[#00a651] text-white hover:bg-[#292667]' : 'bg-[#fbee21] text-[#292667] hover:bg-white'}`}
              >
      ...
      <div className="max-w-[1000px] mx-auto w-full px-2">
        <div className={`bg-white rounded-[1.5rem] p-5 md:p-6 shadow-md border border-slate-100 relative overflow-hidden z-20 ${!isMainAdmin ? '-mt-10' : 'mt-0'}`}>
          <div className="absolute top-0 right-0 w-32 h-32 bg-[#fbee21]/5 rounded-full -mr-16 -mt-16 blur-2xl"></div>
          ...
          <div className="relative z-10 space-y-3">
            <div className="flex flex-col md:flex-row md:items-start justify-between gap-4">
              ...
              {canEnroll && onEnroll && (
                <button 
                  onClick={() => onEnroll()}
                  className="group/enroll px-5 py-2.5 bg-[#fbee21] hover:bg-[#292667] hover:text-white text-[#292667] rounded-xl font-black text-[10px] uppercase tracking-[0.1em] shadow-lg transition-all active:scale-95 flex items-center gap-2 border-b-4 border-black/10 shrink-0 self-center md:self-end"
                >
      ...
      <div className="max-w-[1000px] mx-auto w-full px-2">
        <div className="bg-white rounded-[1.5rem] border border-slate-100 shadow-lg flex flex-col overflow-hidden">
              ...
              {course.modules.map((mod, mIdx) => (
                <div key={mod.id} className="relative">
                    <div className="flex items-center justify-between mb-3">
                      <div className="flex items-center gap-3">
                        <div className="w-8 h-8 rounded-lg bg-[#292667] text-[#fbee21] flex items-center justify-center font-black text-sm shadow border-b-2 border-black/10">
                            {mIdx + 1}
                        </div>
                        <div>
          ...
          <div className="p-3 bg-slate-50 border-t border-slate-100 flex items-center justify-between">
              <div className="flex items-center gap-1.5">
                <Star size={12} className="text-[#fbee21] fill-current" />
