...
export const EditCertificatesView: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col gap-3 overflow-hidden animate-in fade-in duration-500">
      {/* Compact Header - Matched with other pages */}
      <div className="w-full bg-[#292667] rounded-xl p-4 md:p-5 text-white shadow-xl border-b-6 border-[#a855f7] flex flex-col md:flex-row items-center justify-between gap-4 flex-shrink-0 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-64 h-64 bg-white/5 rounded-full -mr-16 -mt-16 blur-3xl"></div>
        <div className="flex items-center gap-3 relative z-10">
           <div className="p-2.5 bg-[#a855f7] rounded-lg text-white shadow-lg rotate-3">
             <Award size={22} strokeWidth={3} />
           </div>
           <div>
             <h2 className="text-lg md:text-xl font-black leading-none tracking-tight uppercase">Branding <span className="text-[#fbee21]">Hub</span></h2>
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-3 overflow-hidden pb-1">
        ...
        <div className="lg:col-span-4 bg-white rounded-2xl p-6 border border-slate-100 shadow-xl overflow-y-auto scrollbar-hide flex flex-col">
           <h3 className="text-sm font-black text-[#292667] uppercase tracking-tight mb-6 flex items-center gap-2">
             <Palette size={16} className="text-[#a855f7]" /> Asset Customizer
           </h3>
           ...
           <div className="space-y-4 flex-1 pr-1">
              <div className="space-y-1">
                 ...
                 <select 
                    className="w-full px-4 py-2.5 bg-slate-50 border-2 border-slate-100 rounded-xl font-black text-[10px] uppercase outline-none focus:border-[#a855f7] transition-all appearance-none cursor-pointer"
              ...
              <div className="space-y-1">
                 ...
                 <div className="relative">
                    ...
                    <input 
                      type="text" 
                      className="w-full pl-10 pr-4 py-2.5 bg-slate-50 border-2 border-slate-100 rounded-xl font-black text-xs uppercase outline-none focus:border-[#a855f7] transition-all"
              ...
              <div className="grid grid-cols-2 gap-3">
                <div className="space-y-1">
                   ...
                   <input 
                      type="text" 
                      className="w-full px-4 py-2.5 bg-slate-50 border-2 border-slate-100 rounded-xl font-black text-xs uppercase outline-none focus:border-[#a855f7] transition-all"
                ...
                <div className="space-y-1">
                   ...
                   <input 
                      type="date" 
                      className="w-full px-4 py-2.5 bg-slate-50 border-2 border-slate-100 rounded-xl font-black text-[9px] uppercase outline-none focus:border-[#a855f7] transition-all"
        ...
        <div className="lg:col-span-8 flex flex-col gap-3 overflow-hidden">
           ...
           <div className="flex items-center justify-center gap-3">
              <div className="flex items-center gap-2 bg-white px-4 py-2 rounded-full shadow-md border border-slate-100">
                 ...
                 <span className="text-[8px] font-black uppercase tracking-widest text-[#292667]">Live Preview Active</span>
              </div>
           </div>
        </div>
      </div>
