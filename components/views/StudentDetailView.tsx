    ...
    <div className="h-full flex flex-col gap-4 overflow-hidden animate-in slide-in-from-right duration-500">
      ...
      <div className="w-full bg-[#292667] rounded-2xl p-6 text-white shadow-xl border-b-8 border-[#ec2027] flex flex-col md:flex-row items-center justify-between gap-6 flex-shrink-0 relative overflow-hidden">
        ...
        <div className="flex items-center gap-6 relative z-10">
           ...
           <div>
             <h2 className="text-2xl font-black leading-none tracking-tight uppercase">{student.firstName} <span className="text-[#fbee21]">{student.lastName}</span></h2>
             <div className="flex items-center gap-2 mt-2">
                ...
                <span className="text-[10px] font-black text-[#fbee21] uppercase tracking-widest opacity-60">ID: {student.username}</span>
             </div>
           </div>
        </div>
        ...
        <div className="flex items-center gap-8 px-6 md:border-l-2 border-white/10 relative z-10">
           <div className="text-center">
              <p className="text-3xl font-black text-[#fbee21] leading-none mb-1">{student.finalGrade}%</p>
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-4 overflow-hidden pb-1">
        <div className="lg:col-span-4 flex flex-col gap-4 overflow-hidden">
           <div className="bg-white rounded-3xl p-6 shadow-md border border-slate-100 text-center flex-shrink-0">
             ...
             <p className="text-[9px] font-black text-[#ec2027] uppercase tracking-widest">Verified Learner</p>
           </div>
             ...
             <div className="space-y-6 flex-1 overflow-y-auto scrollbar-hide pr-1">
                <div className="bg-white/5 p-4 rounded-xl border border-white/5">
                   <div className="flex justify-between items-center mb-2">
                     ...
                     <span className="text-xl font-black text-[#fbee21]">{student.finalGrade}%</span>
                   </div>
                   <div className="w-full bg-white/5 h-2 rounded-full overflow-hidden border border-white/10">
                     <div className="bg-[#fbee21] h-full transition-all duration-1000" style={{ width: `${student.finalGrade}%` }}></div>
                   </div>
                </div>
             </div>
           </div>
                  ...
                  <div key={i} className="p-4 bg-slate-50 rounded-2xl border-2 border-transparent hover:border-indigo-100 hover:bg-white transition-all flex items-center justify-between group shadow-sm">
                    <div className="flex items-center gap-4">
                       ...
                       <div>
                          ...
                          <p className="text-[9px] font-bold text-slate-400 uppercase tracking-widest">{sub.date} • {sub.status}</p>
                       </div>
                    </div>
