...
export const CertificatesView: React.FC = () => {
  ...
  return (
    <div className="h-full flex flex-col gap-6 overflow-hidden">
      {/* Standardized Header */}
      <div className="w-full bg-[#292667] rounded-[2.5rem] p-6 md:p-8 text-white shadow-xl border-b-[10px] border-[#a855f7] flex flex-col md:flex-row items-center justify-between gap-6 flex-shrink-0 relative overflow-hidden">
        <div className="absolute top-0 right-0 w-80 h-80 bg-white/5 rounded-full -mr-24 -mt-24 blur-3xl"></div>
        <div className="flex items-center gap-6 relative z-10">
           <div className="p-4 md:p-5 bg-[#a855f7] rounded-2xl text-white shadow-xl rotate-3">
             <Award size={32} strokeWidth={3} />
           </div>
           <div>
             <h2 className="text-2xl md:text-3xl font-black leading-none tracking-tight uppercase">Award <span className="text-[#fbee21]">Hub</span></h2>
        ...
        <div className="flex items-center gap-8 relative z-10 bg-white/5 px-6 py-4 rounded-2xl border border-white/10 backdrop-blur-sm">
           <div className="text-center">
              <p className="text-3xl font-black text-[#fbee21] leading-none">12</p>
              <p className="text-[9px] font-black uppercase text-white/40 tracking-widest mt-1">Issued</p>
           </div>
           <div className="w-px h-10 bg-white/10"></div>
           <div className="text-center">
              <p className="text-3xl font-black text-[#00a651] leading-none">0</p>
      ...
      <div className="flex-1 grid grid-cols-1 lg:grid-cols-12 gap-8 overflow-hidden pb-4">
        <div className="lg:col-span-4 flex flex-col gap-6 overflow-hidden">
          <div className="bg-white p-6 md:p-8 rounded-[2.5rem] border border-slate-100 shadow-xl flex-1 flex flex-col overflow-hidden">
            <h3 className="font-black text-[#292667] text-sm uppercase tracking-tight mb-8 flex items-center gap-3">
              <Sparkles className="text-amber-500" size={18} /> Configuration
            </h3>
            ...
            <div className="space-y-5 flex-1 overflow-y-auto scrollbar-hide pr-2">
              <div className="space-y-1.5">
                ...
                <div className="relative">
                  <select 
                    className="w-full bg-slate-50 px-5 py-3.5 rounded-2xl border border-slate-100 outline-none font-black text-[#292667] uppercase text-[10px] appearance-none cursor-pointer"
              ...
              <div className="space-y-1.5">
                ...
                <input 
                  type="text"
                  className="w-full bg-slate-50 px-5 py-3.5 rounded-2xl border border-slate-100 outline-none font-black text-[#292667] uppercase text-[10px]"
            ...
            <button className="w-full py-5 mt-6 bg-[#ec2027] text-white rounded-2xl font-black text-xs uppercase tracking-widest flex items-center justify-center gap-3 hover:bg-[#292667] transition-all shadow-xl active:scale-95 border-b-4 border-black/10">
        ...
        <div className="lg:col-span-8 flex flex-col gap-6 overflow-hidden">
          <div className="flex-1 bg-white rounded-[3rem] border-[10px] border-double border-amber-200 p-8 md:p-12 text-center relative shadow-2xl flex flex-col items-center justify-center overflow-hidden">
            ...
            <div className="mb-8">
              <h2 className="text-4xl md:text-5xl font-black text-[#292667] mb-4 uppercase tracking-tight leading-none">{selectedStudent.firstName} {selectedStudent.lastName}</h2>
              ...
              <p className="text-base text-slate-600 max-w-lg mx-auto leading-relaxed">
                For successfully completing the <span className="font-black text-[#ec2027] uppercase">{certData.courseTitle}</span> program.
              </p>
            </div>

            <div className="grid grid-cols-2 gap-12 w-full max-w-md mt-4">
              <div className="space-y-1">
                <p className="font-black text-lg text-[#292667] uppercase tracking-tighter">Educator Jane</p>
              ...
              <div className="space-y-1">
                <p className="font-mono font-black text-lg text-[#292667]">{certData.date}</p>
                <div className="h-0.5 bg-slate-200 w-full mb-1"></div>
                <p className="text-slate-400 uppercase tracking-widest font-black text-[7px]">Issue Date</p>
              </div>
            </div>

            <div className="absolute bottom-8 right-8 bg-[#292667]/5 px-4 py-2 rounded-xl flex items-center gap-2">
              <ShieldCheck size={14} className="text-[#00a651]" />
              <span className="text-[9px] text-[#292667] font-black font-mono tracking-widest uppercase">
          ...
          <div className="flex justify-center gap-6 shrink-0">
            <button className="flex items-center gap-3 px-10 py-4 bg-[#292667] text-white rounded-full font-black text-xs uppercase tracking-widest shadow-lg hover:scale-105 transition-all">
